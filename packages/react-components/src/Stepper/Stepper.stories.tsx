...
import {StepperStepProps} from './StepperProps.types'
...
const defaultSteps: StepperStepProps[] = [
  {
    id: 1,
    label: 'Step 1'
  },
...
const stepsWithDescriptions: StepperStepProps[] = [
  {
    id: 1,
    label: 'Step 1',
...
const stepsWithDisabled: StepperStepProps[] = [
  {
    id: 1,
    label: 'Step 1'
  },
